This directory contains the ryu subdirectory of https://github.com/ulfjack/ryu,
along with the README.md and LICENSE* files from that repo's root directory.
