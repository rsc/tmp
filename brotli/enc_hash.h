...
#include "enc_compound_dictionary.h"
#include "enc_encoder_dict.h"
#include "enc_fast_log.h"
#include "enc_find_match_length.h"
#include "enc_memory.h"
#include "enc_quality.h"
#include "enc_static_dict.h"
...
#include "enc_hash_to_binary_tree_inc.h"  /* NOLINT(build/include) */
...
#include "enc_hash_longest_match_quickly_inc.h"  /* NOLINT(build/include) */
...
#define HASHER() H5
#include "enc_hash_longest_match_inc.h"  /* NOLINT(build/include) */
#undef HASHER

#define HASHER() H6
#include "enc_hash_longest_match64_inc.h"  /* NOLINT(build/include) */
#undef HASHER
...
#define BANK_BITS 16
#define HASHER() H40
#include "enc_hash_forgetful_chain_inc.h"  /* NOLINT(build/include) */
#undef HASHER
...
#include "enc_hash_rolling_inc.h"  /* NOLINT(build/include) */
#undef JUMP
#undef HASHER
...
#include "enc_hash_composite_inc.h"  /* NOLINT(build/include) */
#undef HASHER_A
#undef HASHER_B
#undef HASHER
